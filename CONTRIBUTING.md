# Contributing to GoodReads Quotes PDF
...
- **Fix issues**: Check the [Issues](https://github.com/DrKenReid/GoodReads-Quotes-PDF/issues) tab.
...
```bash
git clone https://github.com/DrKenReid/GoodReads-Quotes-PDF.git
